...
\begin{enumerate}
    ...
    \item Заменяем каждый $i$-ый криволинейный сектор на круговой сектор $R = \rho(\Psi_i),\ i = \overline{1, n}$ % рисунок -> рисунок
    ...
    \begin{flalign*}
        & \lim_{\lambda \to 0} \frac{1}{2} \sum_{i=1}^{n} \rho^2 (\Psi_i)\cdot \Delta \varphi_i = \boxed{\frac{1}{2} \int_{\alpha}^{\beta} \rho^2 \dd{\varphi} = S} &
    \end{flalign*}
\end{enumerate}
